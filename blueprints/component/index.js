...
module.exports = class ComponentBlueprint extends Blueprint {
  ...
  install(options) {
    ...
    return super.install.apply(this, arguments);
  }
  ...
  uninstall(options) {
    ...
    return super.uninstall.apply(this, arguments);
  }
  ...
  afterInstall(options) {
    super.afterInstall.apply(this, arguments);
  ...
  files() {
    let files = super.files.apply(this, arguments);
